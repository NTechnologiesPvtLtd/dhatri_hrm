				...
				<form action="RegistrationServlet" method="post">
					<div class="panel panel-default">
						...
						<table>
							...
							<tr>
								<td>Date Of Birth*:</td>
								<td><input type="date" name="dob" onkeypress="clearForm()"
									id="dob"><br> <br></td>
							...
							<tr>
								<td>Aadhar Number*:</td>
								<td><input type=text name="aadharNo"
									onkeypress="clearForm()" id="aadharNo" pattern="[0-9]{12}"
									title="Aadhar Card Number must be 12 digits"
									placeholder="Enter AadharCardNumber" required><br>
									<br></td>
