...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			<li class="active"><a href="index.jsp"><strong>Home</strong></a></li>
			<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><strong>Employee</strong> <span class="caret"></span></a>
			...
			<li><a href="Aboutus.jsp"><strong>Aboutus</strong></a></li>
		</ul>
	</div>
</nav>
					...
					<div class="card" style="background-color:transparent; color:blue; ">
						...
						<div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne">
							...
							<div class="container">
								...
								<div class="row">
									<div class="col-sm-6" align="left"> Mobile No:<font color="red">*</font> &nbsp;
										<input type=text onkeypress="clearForm()" id="mobileNumber" name="mobileNumber" text-align="right" pattern="[0-9]{10}" title="Mobile number must be 10 digits" placeholder="Mobile number" required><br> <br>
										<p id="errorMsg6" style="color: red;"></p>
									</div>
									<div class="col-sm-6" align="left"> Alternate Mobile No:<font color="red">*</font> &nbsp;
										<input type=text onkeypress="clearForm()" id="alternatemobileNumber" name="alternatemobileNumber" text-align=right pattern="[0-9]{10}" title="Alternate Mobile number must be 10 digits" placeholder="Mobile number" required><br> <br>
								...
								<div class="row">
									<div class="col-sm-4" align="left"> Aadhar Number:<font color="red">*</font> 
										<input type=text name="aadharNo" onkeypress="clearForm()" id="aadharNo" pattern="[0-9]{12}" title="Aadhar Card Number must be 12 digits" placeholder="Enter AadharCardNumber" required>
										<p id="errorMsg7" style="color: red;"></p>
									</div>
									<div class="col-sm-4" align="left"> PAN Number:<font color="red">*</font> 
										<input type=text name="panNo" onkeypress="clearForm()" id="panNo" pattern="{10}" title="PAN Card Number must be 10 digits" placeholder="Enter PANCardNumber" required>
										<p id="errorMsg25" style="color: red;"></p>
									</div>
									<div class="col-sm-4" align="left"> Passport Number:<font color="red">*</font> 
										<input type=text name="passportNo" onkeypress="clearForm()" id="passportNo" pattern="{8}" title="Passport Number must be 8 digits" placeholder="Enter PassportNumber" required>
								...
								<div class="row">
									<div class="col-sm-8" align="left"> Permanent Address:<font color="red">*</font>
										<textarea onkeypress="clearForm()" id="permanentAddress" name="permanentAddress"></textarea>
										<br><br>
										<p id="errorMsg8" style="color: red;"></p>
									</div>

									<div class="col-sm-4" align="left"> Local Address:<font color="red">*</font>
